...
public class NPCHelper {
    ...
    public static boolean talkToNPC (RSNPC[] npcs) {
        ...
        if (NPCChat.getMessage() != null && NPCChat.getName() != null || InterfaceHelper.clickHereToContinue()) {
            while (NPCChat.clickContinue(true) || InterfaceHelper.clickHereToContinue()) {
